...
- You run this script from the repo root and specify devices via CUDA_VISIBLE_DEVICES:
    CUDA_VISIBLE_DEVICES=0,1 python -m downstream_examples.template.3_finetune_template_1D \
        --config downstream_examples/template/configs/config_script.yaml
...
from downstream_examples.template.configs import TrainingConfig, load_flare_config
from downstream_examples.template.datasets.template_dataset import FlareDSDataset
from downstream_examples.template.lightning_modules.pl_simple_baseline import FlareLightningModule
from downstream_examples.template.metrics.template_metrics import FlareMetrics
...
def build_model(cfg: TrainingConfig, scalers, train_baseline: bool = False) -> L.LightningModule:
    ...
    if train_baseline:
        ...
        from downstream_examples.template.models.simple_baseline import (
